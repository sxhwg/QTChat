...
void ChatPage::AppendChatMsg(std::shared_ptr<TextChatData> msg)
{
    ...
    ChatRole role;
    if (msg->m_from_uid == self_info->m_uid) {
        role = ChatRole::Self;
        ChatItemBase* pChatItem = new ChatItemBase(role);
        pChatItem->setUserName(self_info->m_name);
        pChatItem->setUserIcon(QPixmap(self_info->m_icon));
        ...
        role = ChatRole::Other;
        ChatItemBase* pChatItem = new ChatItemBase(role);
        auto friend_info = UserMgr::GetInstance()->GetFriendById(msg->m_from_uid);
...
void ChatPage::on_receive_btn_clicked()
{
    ...
    QString userName = m_user_info->m_name;
    QString userIcon = m_user_info->m_icon;
